...
THIRD_PARTY_COMPONENTS=( \
	"apigee-stackdriver-logging-agent:1.10.6" \
	"apigee-prom-prometheus:v2.55.0-rc.0" \
	"apigee-stackdriver-prometheus-sidecar:0.9.0" \
	"apigee-kube-rbac-proxy:v0.18.1" \
	"apigee-envoy:v1.31.2" \
	"apigee-prometheus-adapter:v0.12.1" \
	"apigee-asm-ingress:1.19.10-asm.19-distroless" \
	"apigee-asm-istiod:1.19.10-asm.19-distroless" \
	"apigee-fluent-bit:3.1.9" \
	"apigee-open-telemetry-collector:v0.110.0" \
)
